...
function scrollNav() {
  ...
  for (i = 0; i < nav.length; i++) {
    if (this.scrollY >= 80) nav[i].classList.add("scroll-nav__link");
    else nav[i].classList.remove("scroll-nav__link");
  }
}
...
/*==================== CHANGE COLOR LOGO ====================*/
function scrollLogo() {
  let nav = document.getElementsByClassName("cls-11");
  let i;
  // When the scroll is greater than 200 viewport height, add the scroll-header class to the header tag
  for (i = 0; i < nav.length; i++) {
    if (this.scrollY >= 80) nav[i].classList.add("scroll-cls-11");
    else nav[i].classList.remove("scroll-cls-11");
  }
}
